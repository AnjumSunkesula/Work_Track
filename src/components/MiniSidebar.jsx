  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-16 bg-brand-dark flex flex-col items-center py-4 z-40">
      ...
      <nav className="flex flex-col gap-4">
        <NavLink to="/" end className={iconClass}>📊</NavLink>
        <NavLink to="/tasks" className={iconClass}>✅</NavLink>
        <NavLink to="/calendar" className={iconClass}>📅</NavLink>
        <NavLink to="/team" className={iconClass}>👥</NavLink>
      </nav>
    </aside>
  );
}
